<template>
  <el-card>
    <h1 class="me-author-name">博客之路</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;陕西&西安</span>
      <span><i class="me-icon-job"></i> &nbsp;java入门小白</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: 'QQ联系: 980675326'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="">此博客由韩守旭和屈易繁共同完成~</a>'
        }
      }
    },
    methods: {
